...
#define INFRA_RED_VERY_LEFT_GPIO  GPIO_NUM_25
#define INFRA_RED_LEFT_GPIO  GPIO_NUM_33
#define INFRA_RED_MIDDLE_GPIO  GPIO_NUM_32
#define INFRA_RED_RIGHT_GPIO  35
#define INFRA_RED_VERY_RIGHT_GPIO 34
